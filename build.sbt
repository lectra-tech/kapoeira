...
lazy val root = (project in file("."))
  .settings(
    ...
    // confluent
    libraryDependencies += "io.confluent" % "kafka-avro-serializer" % "7.9.9" exclude("javax.ws.rs", "javax.ws.rs-api"),
    libraryDependencies += "io.confluent" % "kafka-json-schema-serializer" % "7.9.9" exclude("javax.ws.rs", "javax.ws.rs-api"),
