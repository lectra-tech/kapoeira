Feature: consumer-json-key-value
  ...
  Background:
    ...
    And input topic
      ...
      | private.euw.kapoeira-dsl-it.jsonvalue.tracking.raw | topic_in | string   | json_value |
    And output topic
      | topic                                                | alias     | key_type | value_type | readTimeoutInSecond |
      | private.euw.kapoeira-dsl-it.jsonvalue.tracking.raw | topic_out | string   | json_value | 10                  |
